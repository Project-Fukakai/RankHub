...
import 'package:rank_hub/games/phigros/services/taptap_service.dart';
...
class PhigrosLoginHandler extends PlatformLoginHandler {
  ...
  Future<PlatformLoginResult?> showLoginPage(BuildContext context) {
    return Navigator.of(context).push(
      MaterialPageRoute(builder: (context) => const _PhigrosLoginPage()),
    );
  }
  ...
  void _startPolling() async {
    ...
    try {
      ...
      Navigator.of(context).pop(
        PlatformLoginResult(
          externalId: userInfo.objectId,
          credentialData: {'type': 'api_key', 'api_key': sessionToken},
          displayName: userInfo.nickname,
          avatarUrl: userInfo.avatar,
        ),
      );
